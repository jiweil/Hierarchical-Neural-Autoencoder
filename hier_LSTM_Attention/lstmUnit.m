function[lstm, h_t, c_t]=lstmUnit(W,parameter,x_t,m_t,h_t_1, c_t_1, ll, t,isTraining)
    ...
    %c_t(c_t>parameter.clipForward)=parameter.clipForward;
    %c_t(c_t<-parameter.clipForward)=-parameter.clipForward;
    %h_t(h_t>parameter.clipForward)=parameter.clipForward;
    %h_t(h_t<-parameter.clipForward)=-parameter.clipForward;
